...
RESOURCES += src/qt/axim.qrc src/qt/axim_locale.qrc

TRANSLATIONS += src/qt/locale/axim_bg.ts \
                src/qt/locale/axim_de.ts \
                src/qt/locale/axim_en.ts \
                src/qt/locale/axim_es.ts \
                src/qt/locale/axim_fi.ts \
                src/qt/locale/axim_fr.ts \
                src/qt/locale/axim_it.ts \
                src/qt/locale/axim_ja.ts \
                src/qt/locale/axim_pl.ts \
                src/qt/locale/axim_pt.ts \
                src/qt/locale/axim_ru.ts \
                src/qt/locale/axim_sk.ts \
                src/qt/locale/axim_sv.ts \
                src/qt/locale/axim_vi.ts \
                src/qt/locale/axim_zh_CN.ts \
                src/qt/locale/axim_zh_TW.ts
