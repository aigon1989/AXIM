...
This means one can have an always-on aximd instance running, and another local aximd/axim-qt instance which connects to this node and receives blocks from it.
