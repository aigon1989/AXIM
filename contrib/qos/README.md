...
This means one can have an always-on staterad instance running, and another local staterad/statera-qt instance which connects to this node and receives blocks from it.
