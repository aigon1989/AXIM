...
RESOURCES += src/qt/statera.qrc src/qt/statera_locale.qrc

TRANSLATIONS += src/qt/locale/statera_bg.ts \
                src/qt/locale/statera_de.ts \
                src/qt/locale/statera_en.ts \
                src/qt/locale/statera_es.ts \
                src/qt/locale/statera_fi.ts \
                src/qt/locale/statera_fr.ts \
                src/qt/locale/statera_it.ts \
                src/qt/locale/statera_ja.ts \
                src/qt/locale/statera_pl.ts \
                src/qt/locale/statera_pt.ts \
                src/qt/locale/statera_ru.ts \
                src/qt/locale/statera_sk.ts \
                src/qt/locale/statera_sv.ts \
                src/qt/locale/statera_vi.ts \
                src/qt/locale/statera_zh_CN.ts \
                src/qt/locale/statera_zh_TW.ts
