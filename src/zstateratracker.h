...
#ifndef STATERA_ZSTATERATRACKER_H
#define STATERA_ZSTATERATRACKER_H
...
public:
    CzSTATERATracker(std::string strWalletFile);
    ~CzSTATERATracker();
...
#endif //STATERA_ZSTATERATRACKER_H
