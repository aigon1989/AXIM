/* src/config/statera-config.h.  Generated from statera-config.h.in by configure.  */
/* src/config/statera-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef STATERA_CONFIG_H

#define STATERA_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.statera.org"
