...
/** Utility functions used by the STATERA Qt UI.
 */
namespace GUIUtil
{
...
// Render STATERA addresses in monospace font
...
// Parse "statera:" URI into recipient object, return true on successful parsing
