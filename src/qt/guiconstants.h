...
/* Axim GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AXIM"
#define QAPP_ORG_DOMAIN "axim.org"
#define QAPP_APP_NAME_DEFAULT "AXIM-Qt"
#define QAPP_APP_NAME_TESTNET "AXIM-Qt-testnet"
