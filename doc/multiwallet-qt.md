...
In order to support loading of multiple wallets in statera-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is statera.cpp.
...
Changes to statera.cpp
----------------------
statera.cpp is the entry point into statera-qt, and as such, will require some minor modifications to provide hooks for
