...
In order to support loading of multiple wallets in axim-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is axim.cpp.
...
Changes to axim.cpp
----------------------
axim.cpp is the entry point into axim-qt, and as such, will require some minor modifications to provide hooks for
