Contributing to AXIM Core
============================

The AXIM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AXIM Core project, and is not to be
confused with overall AXIM Network Protocol consensus changes.

Whether a pull request is merged into AXIM Core rests with the project merge
...
Patches that change AXIM consensus rules are considerably more involved than
...
Where a patch set proposes to change the AXIM consensus, it must have been
...
The project leader is the release manager for each AXIM Core release.
