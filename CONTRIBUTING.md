Contributing to STATERA Core
============================

The STATERA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the STATERA Core project, and is not to be
confused with overall STATERA Network Protocol consensus changes.

Whether a pull request is merged into STATERA Core rests with the project merge
...
Patches that change STATERA consensus rules are considerably more involved than
...
Where a patch set proposes to change the STATERA consensus, it must have been
...
The project leader is the release manager for each STATERA Core release.
