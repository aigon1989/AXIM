...
#   c) node1 mines 32 blocks, so now node 0 has 60001statera, node 1 has 4250statera, node2 has none.
#   d) node0 sends 601 statera to node2, in two transactions (301 statera, then 300 statera).
