...
#   c) node1 mines 32 blocks, so now node 0 has 60001axim, node 1 has 4250axim, node2 has none.
#   d) node0 sends 601 axim to node2, in two transactions (301 axim, then 300 axim).
